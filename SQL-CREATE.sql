...
CREATE TABLE Days(
    ...
    day_timetable INT REFERENCES Timetable(timetable_id) ON DELETE SET NULL
);
CREATE TABLE Class(
...
CREATE TABLE Timetable(
    ...
    timetable_class VARCHAR(10) UNIQUE REFERENCES Class(class_name) CHECK ( timetable_class ~ '^(?:[1-9]|1[0-2])-([А-ЩЬЮЯҐЄІЇ]|[а-щьюяґєії])$') ON DELETE SET NULL
);
